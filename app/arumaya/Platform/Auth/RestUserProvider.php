...
class RestUserProvider implements UserProvider
{
    ...
    public function retrieveByCredentials(array $credentials){
        ...
        return $this->retrieveById($credentials['identifier']);
    }
    ...
    protected function getUserByIdentifier($identifier){ //todo: here
        ...
        $model = $this->createModel();
        $result = $model->findUser($identifier, $model->getKey());
        if($result !== NULL){
            $model->setAttribute($model->getKeyName(), $result->UserID);
            ...
            $model->RememberToken = $result->RememberToken;
            $model->Activated = $result->Activated;
